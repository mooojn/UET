    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    Console.Clear();  // for refreshing display
                    showTop3 = aggregateCal(studentData, stdCount);
                }
        ...
        static Student addStudentData()
        {
            ...
            return new Student(stdName, matric, fsc, ecat);
        }
        ...
        static bool aggregateCal(Student[] stds, int count)
        {
            // calculations
            for (int i = 0; i < count; ++i)
            {
                stds[i].aggregateCalculator();
            }
